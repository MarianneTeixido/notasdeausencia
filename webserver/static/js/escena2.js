  ...
  //    controls.maxDistance = 500;
     ...
     //  controls.maxPolarAngle = Math.PI / 2;
	  ...
	  for(var i = 0; i < tam.length ; i ++){
	      ...
	      //mesh.geometry.
	      cube[i].position.x = posX * (0.5*tam[i]);
	      cube[i].position.y = posY * (0.5*tam[i]);
	      cube[i].position.z = posZ * (0.5*tam[i]);

	      cube[i].scale.x = tam[i]/1200;
	      cube[i].scale.y = tam[i]/1200;
	      cube[i].scale.z = tam[i]/1200;
	      ...
	      var shapes = font.generateShapes( tweets[i], tam[i]/32 );
